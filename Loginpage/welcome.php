  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="cropdetails.php">Crop Details</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text"><img src="Images/w.png" alt="Verify Logo"></p>
        <a href="cropsell.php" >Crop Sell</a>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <!-- <h5 class="card-title">Verify Crop</h5> -->
        <p class="card-text"><img src="Images/w.png" alt="Verify Logo"></p>
        <a href="landregistraion.php">Land Registration And Soil Card</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <!-- <h5 class="card-title">Verify Land</h5> -->
        <p class="card-text"><img src="Images/w.png" alt="Verify Logo"></p>
        <a href="askadvice.php" >Ask Query</a>
      </div>
    </div>
  </div>
</div>
