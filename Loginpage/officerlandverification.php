  ...
  if(mysqli_query($conn, $sql_04))
{
    ...
    // header("location:officerverify.php");
}
else
{
...
<html lang="en">
  ...
  <div class="heade">
    ...
    <center><h4 style="margin-top:170px" class="text-white">Mail to farmer who's land is verified and can come to office for documents</h4></center>
          ...
          <div class="card-body">
            ...
            <table class="table table-bordered text-center">
              ...
              <!-- <tr onclick="hideRow(this)"> -->
                ...
                <!-- <td><button onclick="hideRoww(this)">Answer Query</button></td> -->
                <!-- <td><a href="" onclick=hideRow(event)></a></td> -->
                </tr>
                <?php
                }
                ?>
