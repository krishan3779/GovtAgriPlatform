...
label{
  ...
  <div class="heade">
    ...
    width:1200px;">
    <center><h4 style="color:white;margin-top:-48px;">Queries Section</h4></center>
  ...
  <div class="form-group" >
    ...
    <small id="emailHelp" class="form-text text-muted">You will get a call on this number if this option is selectd by you</small>
  </div>
  <div class="form-group">
    <label for="emailaddress">Email address</label>
    <input type="email" class="form-control" name="emailaddress"  placeholder="Enter Email Address">
    <small id="emailHelp" class="form-text text-muted">You will get a email on this mail id if this option is selectd by you</small>
  </div>
  <div class="form-group">
  ...
  <button type="submit" name="submit" class="btn btn-primary">Submit</button>
    ...
    <script>document.getElementById("calloremail").selectedIndex = -1;</script>
    <!-- Optional JavaScript -->
