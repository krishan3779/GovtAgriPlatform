...
if(isset($_POST['send'])){
    ...
    //     // $exists = true;
       echo '<script> alert("These Details already exists"); </script>';
        ...
        //  $adhnumber =  "SELECT password FROM farmer_login where emailAddress='$aadharNumber'";
         //$pass =  "Select * from farmer_login where password='$password'";
...
//      alert("Recorded successfully and mail is sent");
//      </script>'
// ;
...
<html lang="en">
  ...
  <div class="nwform" style="margin-left:240px;" >
      <form action="/loginpage/newdetails.php" method="post">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="email" class="form-control" id="inputAdhar" placeholder="email@example.com" name="inputAdhar">
    </div>
        <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" id="inputSeedName" placeholder="e.g:BH010" name="inputSeedName">
    </div>
    <div class="form-group col-md-3">
                <label for="inputLandId">Land ID</label>
                <input type="text" class="form-control" id="inputLandId" placeholder="e.g:LDNI12" name="inputLandId"/>
    </div>
  </div>
  <div class="form-row">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="number" class="form-control" id="inputWatering" name="inputWatering" placeholder="e.g:2">
    </div>
    <!-- <div class="form-group col-md-2">
      <label for="inputCropType">Crop Type</label>
      <input type="text" class="form-control" id="inputCropType" name="inputCropType">
    </div> -->
    <div class="form-group col-md-2">
      <label for="inputCropType">Crop Type</label>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputFertilizers" placeholder="e.g:Urea,DAP" name="inputFertilizers">
  </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="number" class="form-control" id="inputInvetment" name="inputInvetment" placeholder="e.g:1000">
    </div>
    <div class="form-group col-md-2">
      <label for="inputInvestment">Total Income</label>
      <input type="number" class="form-control" id="inputIncome"  name="inputIncome" placeholder="e.g:10000">
    </div>
  ...
  <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control" id="inputPassword" name="inputPassword" placeholder="12xxxxxxxx34">
    </div>
  </div>
