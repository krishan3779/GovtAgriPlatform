...
if(isset($_POST['verify'])){
    ...
    $mail->Subject="Land Verification";
    $mail->Body="Your entered land details are verified and you can come to office for documents and for soil card details".$_POST["datt"];
